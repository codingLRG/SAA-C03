...
> A [[SQS]] can be utilized to store from [[EC2]] to DB like [[RDS]] while automatically processing order if an outage happens
...
- Utilizing a [[ECS]] targeted by a [[EventBridge]] would require a refactor
